...
import { getVendorDashboardData, sendReminder } from '../../controllers/vendor/dashboard.controller';
...
router.post('/customers/:id/remind', verifyToken, authorizeRoles('VENDOR'), sendReminder);
