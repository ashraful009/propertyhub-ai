  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100">
      ...
      <div className="space-y-4">
        <button className="w-full flex items-center justify-center gap-2 bg-blue-50 text-blue-700 font-semibold py-3.5 rounded-xl hover:bg-blue-100 transition-colors">
          <Calculator size={20} />
